...
namespace Fromthink\EasyWeChat\Tests\OpenWork\Work\Auth;
...
class AccessTokenTest extends TestCase
{
    ...
    public function testEndpoint()
    {
        ...
        $openWork['suite_access_token'] = \Mockery::mock(\Fromthink\EasyWeChat\OpenWork\SuiteAuth\AccessToken::class, function ($mock) {
