...
class StreamResponseTest extends TestCase
{
    ...
    public function testSave()
    {
        ...
        // not writable
        $this->expectException(\Fromthink\EasyWeChat\Kernel\Exceptions\InvalidArgumentException::class);
    ...
    public function testSaveWithEmptyContent()
    {
        // empty contents
        $directory = vfsStream::url('testing');
        $this->expectException(\Fromthink\EasyWeChat\Kernel\Exceptions\RuntimeException::class);
