...
namespace Fromthink\EasyWeChat\Tests\Work\Jssdk;
...
use Fromthink\EasyWeChat\Work\Jssdk\Client;
...
class ClientTest extends TestCase
{
    ...
    {
        $client = $this->mockApiClient(\Fromthink\EasyWeChat\Work\Jssdk\Client::class, 'agentConfigSignature', new Application());
